...
function Bookmark () {
    return (
        <Image style={{width:24, height:24}} source={require("./../assets/bookmark.png")}/>
    )
}

function Comment () {
    return (
        <Image style={{width:24, height:24}} source={require("./../assets/comment.png")}/>
    )
}

function Share () {
    return (
        <Image style={{width:24, height:24}} source={require("./../assets/share.png")}/>
    )
}

function Dropdown () {
    return (
        <Image style={{width:24, height:24}} source={require("./../assets/dropdown.png")}/>
    )
}

function BurgerMenu () {
    return (
        <Image style={{width:24, height:24}} source={require("./../assets/burger.png")}/>
    )
}
export {Logo,Home,HomeField,Search,SearchField ,Reel,ReelField, Shop,ShopField,Plus,Heart ,Messenger,Dots,Bookmark,Comment,Share, Dropdown,BurgerMenu};